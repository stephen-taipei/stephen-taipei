...
13+ years of software engineering across architecture, full-stack systems, CI/CD, production delivery, engineering leadership, and AI-native development.
...
Selected production architecture work from my frontend engineering background:

- Designed and led an Angular/Nx architecture supporting 100+ themes, reducing a representative production theme leaf to **23 lines**.
...
Selective conversations around agentic systems, AI agent reliability, developer infrastructure, and OSS collaboration are welcome.
